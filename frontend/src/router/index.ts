    ...
    children: [
      {
        ...
        meta: { title: '工作台', requiresAdminAuth: true },
      },
      {
        path: 'admins',
        name: 'AdminList',
      ...
      },
      {
        ...
        meta: { title: '品牌管理', requiresAdminAuth: true },
      },
      {
        path: 'products',
        name: 'AdminProducts',
      ...
      },
      {
        ...
        meta: { title: '社区管理', requiresAdminAuth: true },
      },
      {
        path: 'roles',
        name: 'AdminRoles',
        component: () => import('@/views/admin/roles/Index.vue'),
        meta: { title: '角色管理', requiresAdminAuth: true },
      },
      {
        path: 'banners',
        name: 'AdminBanners',
        component: () => import('@/views/admin/banners/Index.vue'),
        meta: { title: 'Banner管理', requiresAdminAuth: true },
      },
      {
        path: 'coupons',
        name: 'AdminCoupons',
